...
public class Test013 extends BaseTest {
	...
	public void test013() throws Exception {
		try {
			...
			saveAddQuestion(driver, Constant.SHORT_ANS_QUESTION, jse);

			// Search by title and question type
			searchQuestion(driver, Constant.SHORT_ANS_QUESTION, "QuestionTest");
