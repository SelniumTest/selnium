...
public class Test010 extends BaseTest {
	...
	public void test010() throws Exception {
		try {
			...
			saveAddQuestion(driver, Constant.TRUE_FALSE_QUESTION, jse);

			// Search by title and question type
			searchQuestion(driver, Constant.TRUE_FALSE_QUESTION, "QuestionTest");
