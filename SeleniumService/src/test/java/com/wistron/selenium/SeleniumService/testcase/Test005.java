...
public class Test005 extends BaseTest {
	...
	public void test005() throws Exception {
		try {
			...
			searchQuestion(driver, Constant.SELECTION_QUESTION, "QuestionTest");
			jse.executeScript("window.scrollBy(0,\"650\")");
			Thread.sleep(2000);

			// Edit question by question type
			editQuestion(driver, Constant.SELECTION_QUESTION, jse);
